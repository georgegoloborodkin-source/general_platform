...
1. Define the AI's identity (e.g., "You are Company Assistant, a [company type] intelligence system built for [team type]")
...
FALLBACK_PROMPT = """You are Company Assistant, an enterprise intelligence system built for your team.
...
def _build_simple_prompt(company_description: str) -> str:
    ...
    return f"""You are Company Assistant, an intelligent assistant built specifically for the following company:
